...
public class vistaTienda extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel4.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Imagenes/La Clave (1).png"))); // NOI18N

        jLabel5.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Imagenes/Note-musique-icon.png"))); // NOI18N

        jLabel6.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Imagenes/Note-musique-icon.png"))); // NOI18N
        ...
        jMenu_EditarSonido.setAccelerator(javax.swing.KeyStroke.getKeyStroke(java.awt.event.KeyEvent.VK_M, java.awt.event.InputEvent.CTRL_DOWN_MASK));
        jMenu_EditarSonido.setFont(new java.awt.Font("Rockwell Condensed", 0, 16)); // NOI18N
        jMenu_EditarSonido.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Imagenes/ajustes.png"))); // NOI18N
        jMenu_EditarSonido.setText("Editar");
        jMenu_EditarSonido.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jMenu_EditarSonidoActionPerformed(evt);
            }
        });
        jMenu_RegistrarSonido_.add(jMenu_EditarSonido);
